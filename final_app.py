from Labels import Labels, classes
...
if choice == 'Upload image':
    ...
    if image_file is not None:
        ...
        min_req_acc = st.slider(
            "Select minimum required predicted accuracy", min_value=0, max_value=100, value=50)
        ...
        if(max_value >= min_req_acc):
            ...
            st.write(
                "No object was able to be predicted on that minimum required accuracy")
    ...
    if required_object in classes:
        st.write("Shape of : ", required_object,
                 " is : ", classes[required_object])
    ...
    st.write(
        "The team is always open for feedback and constructive criticism. Contact us at : ")
